...
server.listen(0, '127.0.0.1', () => {
  ...
  // same per-OS resolution as app/config.js (FOCUSROOM_PYTHON wins) — the
  // hardcoded Windows venv path made every harness run ENOENT on macOS
  const py = process.env.FOCUSROOM_PYTHON || (process.platform === 'win32'
